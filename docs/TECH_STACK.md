...
9. **Motion and maintenance** ✅ — animations where they carry meaning (in-tune spring, star sparks, rolling chords, countdown ring, rows that fold and grow, cascades) with Reduce Motion support and flourishes still in Red night (`lib/core/widgets/motion.dart`, DESIGN.md § Motion); Flutter 3.44 → 3.47, packages and Android build tools updated, iOS minimum 15.0; second security audit (SECURITY.md). Tested on a real iPhone.
